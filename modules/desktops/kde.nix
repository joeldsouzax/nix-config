      ...
      programs.plasma = {
        ...
        configFile = {
          ...
          "kglobalshortcutsrc"."systemsettings.desktop"."_k_friendly_name" =
            "System Settings";
          "kglobalshortcutsrc"."wacomtablet"."_k_friendly_name" =
            "Wacom Tablet";
          ...
          "khotkeysrc"."Data_2_6Actions0DestinationWindow0"."Class" =
            "XMMS_Player";
          ...
          "khotkeysrc"."Data_3Conditions0Window0"."Role" =
            "konqueror-mainwindow#1";
          "khotkeysrc"."Data_3Conditions0Window0"."RoleType" = 0;
          "khotkeysrc"."Data_3Conditions0Window0"."Title" =
            "file:/ - Konqueror";
