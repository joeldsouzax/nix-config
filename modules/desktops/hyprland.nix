...
with host; {
  ...
  config = mkIf (config.hyprland.enable) {
    ...
    in {
      ...
      sessionVariables = if hostname == "main" then {
    ...
    services.greetd = {
      ...
      settings = {
        default_session = {
          ...
          command =
            "${config.programs.hyprland.package}/bin/Hyprland"; # tuigreet not needed with exec-once hyprlock
          user = vars.user;
        };
      };
      vt = 7;
      ...
      wayland.windowManager.hyprland = with colors.scheme.default.hex; {
        ...
        settings = {
          ...
          monitor = [
            ...
            "${toString mainMonitor},3840x2160@60,1920x0,1"
          ];
          workspace = [
